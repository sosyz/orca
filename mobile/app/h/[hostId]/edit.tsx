...
export default function EditHostScreen() {
  ...
  async function handleSave() {
    ...
    if (nextEndpoint !== undefined) {
      // An edited address replaces even a Relay-active client and reads the committed host profile.
      try {
        refreshHostClient(host.id, { reconnectUnowned: true })
      } catch {
        // The save already committed; reconnect failures must not turn it into a form error.
      }
    }
  }
