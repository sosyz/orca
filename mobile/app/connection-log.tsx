...
import { connectionLogScreenStyles as styles } from '../src/diagnostics/connection-log-screen-styles'
...
export default function ConnectionLogScreen() {
  ...
  const [copyFailedHostId, setCopyFailedHostId] = useState<string | null>(null)
  ...
  const copyFailed = copyFailedHostId === selectedId
