...
import { XTERM_EMOJI_FONT_WOFF2_BASE64 } from './terminal-webview-emoji-font.generated'
...
@font-face {
  font-family: "Orca Emoji";
  src: url("data:font/woff2;base64,${XTERM_EMOJI_FONT_WOFF2_BASE64}") format("woff2");
  font-style: normal; font-weight: 400; font-display: block;
}`
