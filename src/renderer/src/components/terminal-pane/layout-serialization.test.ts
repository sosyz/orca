...
// ---------------------------------------------------------------------------
const FULL_FALLBACK =
  '"SF Mono", "Menlo", "Monaco", "Cascadia Mono", "Consolas", "DejaVu Sans Mono", "Liberation Mono", "Orca Nerd Font Symbols", "Symbols Nerd Font Mono", "MesloLGS NF", "JetBrainsMono Nerd Font", "Hack Nerd Font", monospace'
...
describe('buildFontFamily', () => {
  ...
  it('does not duplicate when font name contains "sf mono" (case-insensitive)', () => {
    ...
    expect(result).toBe(
      '"My SF Mono Custom", "Menlo", "Monaco", "Cascadia Mono", "Consolas", "DejaVu Sans Mono", "Liberation Mono", "Orca Nerd Font Symbols", "Symbols Nerd Font Mono", "MesloLGS NF", "JetBrainsMono Nerd Font", "Hack Nerd Font", monospace'
    )
  })
  ...
  it('does not duplicate Consolas when it is the input', () => {
    ...
    expect(result).toBe(
      '"Consolas", "SF Mono", "Menlo", "Monaco", "Cascadia Mono", "DejaVu Sans Mono", "Liberation Mono", "Orca Nerd Font Symbols", "Symbols Nerd Font Mono", "MesloLGS NF", "JetBrainsMono Nerd Font", "Hack Nerd Font", monospace'
    )
  })

  it("does not duplicate Powerlevel10k's MesloLGS NF when it is the input", () => {
    const result = buildFontFamily('MesloLGS NF')
    expect(result).toBe(
      '"MesloLGS NF", "SF Mono", "Menlo", "Monaco", "Cascadia Mono", "Consolas", "DejaVu Sans Mono", "Liberation Mono", "Orca Nerd Font Symbols", "Symbols Nerd Font Mono", "JetBrainsMono Nerd Font", "Hack Nerd Font", monospace'
    )
  })
  ...
  it('does not duplicate the bundled Nerd Font symbol fallback', () => {
    ...
    expect(result).toBe(
      '"Orca Nerd Font Symbols", "SF Mono", "Menlo", "Monaco", "Cascadia Mono", "Consolas", "DejaVu Sans Mono", "Liberation Mono", "Symbols Nerd Font Mono", "MesloLGS NF", "JetBrainsMono Nerd Font", "Hack Nerd Font", monospace'
    )
  })
})
